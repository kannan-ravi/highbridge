...
function EmailNode({ id, data }) {
  ...
  return (
    <div className="px-4 py-2 bg-white border-2 rounded shadow-md react-flow__node-default node-email border-stone-400">
      <Handle
        type="target"
      ...
      <div className="flex items-center justify-between">
        <span className="mr-2 text-sm">{data.label}</span>
        <button
